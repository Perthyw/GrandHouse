export const seedData = {
  ...
  company: {
    ...
    centralKitchenName: "ห้องผลิตแกรนด์ เฮาส์"
  },
  branches: [
    { id: "br-phu-doi", name: "ภูดอย", warehouseName: "การเบิกสาขาภูดอย" },
    { id: "br-ban-jo", name: "บ้านโจ้", warehouseName: "การเบิกสาขาบ้านโจ้" },
    { id: "br-kaset-mai", name: "เกษตรใหม่", warehouseName: "การเบิกสาขาเกษตรใหม่" },
    { id: "br-tha-rua-1", name: "ท่ารั้ว", warehouseName: "การเบิกสาขาท่ารั้ว" },
    { id: "br-tha-rua-2", name: "แกรนด์ปาร์ค", warehouseName: "การเบิกสาขาแกรนด์ปาร์ค" }
  ],
  // Owners of stock physically held in the office warehouse.  Phela is a
  // sibling shop, so it is intentionally not added to the operational branch
  // list above.
  stockOwners: [
  ...
  users: [
    ...
    { id: "user-kitchen", username: "kitchen", password: "kitchen", name: "ห้องผลิต", role: "KITCHEN" },
  ...
  // Shared reference values used by the office stock-entry form. Keep these
  // separate from transactions so names can be maintained without changing
  // the movement records themselves.
  inventoryOptions: {
  ...
  foodProducts: [
    ...
    { id: "food-rice", name: "ข้าวหอมมะลิพร้อมเสิร์ฟ", category: "อาหารสำเร็จรูป", unit: "กก.", productionRoom: "ห้องอาหาร", standardCost: 45, sellingPrice: 75 },
    { id: "food-pork-grill", name: "หมูย่างสมุนไพร", category: "อาหารสำเร็จรูป", unit: "กก.", productionRoom: "ห้องอาหาร", standardCost: 180, sellingPrice: 290 },
    { id: "food-chicken-grill", name: "ไก่ย่างซอสพริกไทยดำ", category: "อาหารสำเร็จรูป", unit: "กก.", productionRoom: "ห้องอาหาร", standardCost: 150, sellingPrice: 250 },
    { id: "food-vegetable", name: "ผัดผักรวมมิตร", category: "อาหารสำเร็จรูป", unit: "ถาด", productionRoom: "ห้องอาหาร", standardCost: 90, sellingPrice: 160 },
  ...
  inventorySettings: [
    { branchId: "br-phu-doi", productId: "mat-pork", reorderPoint: 35, reserveTarget: 50 },
  ...
  foodRequests: [
    {
      ...
      timeline: [
        ...
        { at: "2026-07-21T09:35:00.000+07:00", label: "ห้องผลิตรับเรื่อง" },
    ...
    },
    {
      ...
      timeline: [
        ...
        { at: "2026-07-21T09:39:00.000+07:00", label: "ห้องผลิตรับเรื่อง" }
      ]
    },
    {
      id: "KC20260829003",
      ...
      sourceType: "BRANCH_REQUEST",
      status: "COMPLETED",
      createdAt: "2026-08-29T08:10:00.000+07:00",
      updatedAt: "2026-08-29T10:25:00.000+07:00",
      items: [
        { productId: "food-rice", requestedQty: 120, deliveredQty: 120, productionRoom: "ห้องอาหาร", status: "DELIVERED" },
        { productId: "food-pork-grill", requestedQty: 80, deliveredQty: 80, productionRoom: "ห้องอาหาร", status: "DELIVERED" }
      ],
      timeline: [
        { at: "2026-08-29T08:10:00.000+07:00", label: "สาขาสร้างรายการ" },
        { at: "2026-08-29T08:20:00.000+07:00", label: "ห้องผลิตรับเรื่อง" },
        { at: "2026-08-29T10:10:00.000+07:00", label: "จัดส่งแล้ว" },
        { at: "2026-08-29T10:25:00.000+07:00", label: "สาขารับของแล้ว" }
      ]
    },
    {
      id: "KC20260829002",
      ...
      sourceType: "BRANCH_REQUEST",
      status: "COMPLETED",
      createdAt: "2026-08-29T08:05:00.000+07:00",
      updatedAt: "2026-08-29T10:20:00.000+07:00",
      items: [
        { productId: "food-chicken-grill", requestedQty: 65, deliveredQty: 65, productionRoom: "ห้องอาหาร", status: "DELIVERED" },
        { productId: "food-vegetable", requestedQty: 45, deliveredQty: 45, productionRoom: "ห้องอาหาร", status: "DELIVERED" }
      ],
      timeline: [
        { at: "2026-08-29T08:05:00.000+07:00", label: "สาขาสร้างรายการ" },
        { at: "2026-08-29T08:18:00.000+07:00", label: "ห้องผลิตรับเรื่อง" },
        { at: "2026-08-29T10:05:00.000+07:00", label: "จัดส่งแล้ว" },
        { at: "2026-08-29T10:20:00.000+07:00", label: "สาขารับของแล้ว" }
      ]
    },
    {
      id: "KC20260829001",
      ...
      sourceType: "BRANCH_REQUEST",
      status: "COMPLETED",
      createdAt: "2026-08-29T08:00:00.000+07:00",
      updatedAt: "2026-08-29T10:15:00.000+07:00",
      items: [
        { productId: "food-pork", requestedQty: 95, deliveredQty: 95, productionRoom: "ห้องอาหาร", status: "DELIVERED" },
        { productId: "food-chicken", requestedQty: 70, deliveredQty: 70, productionRoom: "ห้องอาหาร", status: "DELIVERED" }
      ],
      timeline: [
        { at: "2026-08-29T08:00:00.000+07:00", label: "สาขาสร้างรายการ" },
        { at: "2026-08-29T08:15:00.000+07:00", label: "ห้องผลิตรับเรื่อง" },
        { at: "2026-08-29T10:00:00.000+07:00", label: "จัดส่งแล้ว" },
        { at: "2026-08-29T10:15:00.000+07:00", label: "สาขารับของแล้ว" }
      ]
    }
  ],
  materialRequests: [
